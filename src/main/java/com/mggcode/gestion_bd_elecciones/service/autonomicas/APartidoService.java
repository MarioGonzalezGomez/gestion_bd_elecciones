...
import com.mggcode.gestion_bd_elecciones.repository.autonomicas.APartidoRepository;
...
@Service
public class APartidoService implements IBaseService<Partido> {

    @Autowired
    private APartidoRepository partidoRepository;
